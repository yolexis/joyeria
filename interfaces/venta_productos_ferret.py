...
from models.consultas import productos_inv, act_prod_ferret,productos_activos_ferret
from utilidades.recursos import resource_path


def seleccionar_cliente_2(nombre_tabla):
    try:
        conexion = conectar()
...
def seleccionar_productos(id_cliente,nombre_tabla):
    #Consulta DB
    datos = productos_activos_ferret()
    ...
    #imagen_icono = Image.open("imagenes/boton_productos.png")
    #imagen_rezize = imagen_icono.resize((30,30))
    #imagen_tk3 = ImageTk.PhotoImage(imagen_rezize) 
...
def listar_productos(id_cliente, prod, nombre_tabla):
    ...
    def guardar_venta(ventana,id_cliente,prod,cantidad,precio,peso,nombre_tabla):
        ...
        valores_sql = list(zip(id_cl,id_prod,cantidad,precio,inventario,fecha_arr))
        valores_tupla = ", ".join([f"{col}" for col in valores_sql])
        
        try:
            conexion = conectar()
            sql = f"INSERT INTO {nombre_tabla} (id_cliente,id_producto, cantidad, precio, inventario, fecha) VALUES {valores_tupla};"
            titulo = "Venta de productos"
    ...
    ventana = tk.Tk()                             
    ventana.title('Venta de productos Ferretería')
    ventana.geometry(f'400x{alto_ventana}')
    ...
    for i in range(len(prod)):
       if i < len(prod):
            ...
            j.grid(column=0, row=control_filas,pady=5, columnspan=4)
            ...
            k.grid(column=2, row=control_filas,pady=5)
            ...
            if i==0:        
                ...
                aa.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==1:               
                ...
                bb.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==2:
                ...
                cc.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==3:
                ...
                dd.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==4:
                ...
                ee.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==5:
                ...
                ff.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==6:
                ...
                gg.grid(column=3, row=control_filas,padx=2,pady=10)   
                control_filas=control_filas+1   
            ...
            if i==7:
                ...
                hh.grid(column=3, row=control_filas,padx=2,pady=10)
                control_filas=control_filas+1   
    ...
    def recuperar_datos():
        ...
        for i in range(len(cantidad)):            
            ...
            if cantidad[i] <=0:
                control = 1
                titulo='Validando'
                mensaje=f'Verifique las cantidades, existen valores negativos.\nVea producto: {prod_validar[i][0]}'
                aceptar_error(titulo,mensaje,ventana)
    ...
    boton_0.grid(row=control_filas, column=0, padx=15, pady=10, columnspan=2)
    ...
    boton_0.grid(row=control_filas, column=2, columnspan=2)
